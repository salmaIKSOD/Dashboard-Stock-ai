...
import { Database, UserCircle2, ChevronRight, ArrowLeft, Users, LogOut } from 'lucide-react';
import logo from '../images/logo.png';
import { useAuth } from '../context/AuthContext';

// Items visibles par tous (admin + employé)
...
const NAV_ITEM_COMPTES = { label: 'Gestion des comptes', path: '/gestion-comptes', icon: Users };
...
export default function SidebarG({ open, onClose }) {
  ...
  return (
    ...
    >
      ...
      <nav className="flex-1 py-4 overflow-y-auto">
        ...
        <div className="px-3 mt-3">
          <button
            ...
            className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-all duration-150"
            style={{ background: 'transparent', color: '#888888', border: 'none', cursor: 'pointer', textAlign: 'left' }}
      ...
      {/* Footer — vrai utilisateur connecté */}
