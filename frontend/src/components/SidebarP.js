          ...
          {/* <div style={{ position: 'relative' }} ref={notifRef}>
            ...
            {notifOpen && (
              <div style={{ ...dropdownStyle, width: '288px' }}>
                ...
                {[
                  { dot: '#12a6e0', text: 'Base synchronisée',                    time: 'Il y a 2 min'  },
                  { dot: '#01d63a', text: 'Nouveaux mouvements détectés',         time: 'Il y a 15 min' },
                ].map((n, i) => (
                  <div key={i}
          ...
          <div style={{ position: 'relative' }} ref={userRef}>
            ...
            {userOpen && (
              <div style={{ ...dropdownStyle, width: '208px' }}>
                ...
                {/* Mon profil — ← AJOUT onClick */}
                <button
                  style={menuItemStyle}
                  onClick={() => { navigate('/profil'); setUserOpen(false); }}
                  onMouseEnter={e => { e.currentTarget.style.background = '#f5f5f5'; e.currentTarget.style.color = '#0d0c0c'; }}
                  onMouseLeave={e => { e.currentTarget.style.background = 'none';    e.currentTarget.style.color = '#555555'; }}
                >
                  <UserCircle2 size={13} />
