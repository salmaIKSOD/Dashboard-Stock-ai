    ...
    <>
      <style>{`
        ...
        @media (max-width: 639px) {
          .es-top-row   { flex-direction: column !important; align-items: flex-start !important; gap: 16px !important; }
          .es-icon-wrap { align-self: center; }
          .es-steps     { width: 100% !important; min-width: unset !important; }
          .es-cards-row { flex-direction: column !important; }
          .es-feat-card { flex: unset !important; width: 100% !important; }
          .es-hero-text { text-align: center; }
          .es-icon-wrap { align-self: center !important; }
        }

        /* Tablette 640–1023px */
        @media (min-width: 640px) and (max-width: 1023px) {
          .es-top-row   { flex-wrap: wrap !important; gap: 16px !important; }
          .es-steps     { width: 100% !important; min-width: unset !important; flex-direction: row !important; align-items: center !important; gap: 0 !important; }
          .es-step-connector { display: none !important; }
          .es-step-pill { width: auto !important; flex: 1; }
          .es-cards-row { flex-wrap: wrap !important; }
          .es-feat-card { min-width: calc(50% - 6px) !important; }
        }
      `}</style>
      ...
      >
        ...
        {/* ── LIGNE HAUTE ── */}
        <div
          className="es-top-row"
          style={{ display: 'flex', alignItems: 'center', gap: 24, padding: '0 4px 20px' }}
        >

          {/* Icône flottante */}
          <div
            className="es-float es-icon-wrap"
            style={{ position: 'relative', width: 80, height: 80, flexShrink: 0 }}
          >
            <svg
              className="es-ring"
              width="80" height="80" viewBox="0 0 72 72"
            ...
            <div style={{
              ...
              background: '#12a6e0', display: 'flex', alignItems: 'center', justifyContent: 'center',
            }}>
          ...
          {/* Texte */}
          <div className="es-hero-text" style={{ flex: 1, minWidth: 0 }}>
          ...
          <div
            className="es-steps"
            style={{ display: 'flex', flexDirection: 'column', gap: 0, flexShrink: 0, minWidth: 150 }}
          >
            {[
              {
                color: '#12a6e0', bg: 'rgba(18,166,224,0.12)', label: 'Base SAGE', num: '1',
                icon: (
              ...
              {
                color: '#7c3aed', bg: 'rgba(124,58,237,0.12)', label: 'Période', num: '2',
                icon: (
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              {
                color: '#01a82e', bg: 'rgba(1,168,46,0.12)', label: 'Filtrer', num: '3',
                icon: (
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <React.Fragment key={label}>
                <div className="es-step-pill">
                  <div style={{
                    width: 22, height: 22, borderRadius: '50%', background: bg, color,
                ...
                {i < 2 && (
                  <div className="es-step-connector" style={{ paddingLeft: 11 }}>
        ...
        <div style={{ borderTop: '1.5px solid #f0f6fb', paddingTop: 18 }}>
          <p style={{
            ...
            color: '#b0c4d4', textTransform: 'uppercase', margin: '0 0 12px 2px',
          }}>
            Ce que vous pouvez faire
          </p>

          <div className="es-cards-row" style={{ display: 'flex', gap: 12 }}>
            {[
              {
              ...
              <div className="es-feat-card" key={title}>
                ...
                <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
                  {tags.map(tag => (
                    <span key={tag} className="es-tag" style={{ background: tagBg, color: tagColor }}>{tag}</span>
                  ))}
                </div>
              </div>
            ))}
        ...
        <div style={{
          ...
          gap: 6, paddingTop: 8, paddingBottom: 4, opacity: 0.38,
        }}>
